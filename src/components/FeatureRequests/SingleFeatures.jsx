...
import { getSingleFeatures, editFeature, deleteFeature } from "../../api/Features";
...
const SingleFeatures = () => {
  ...
  return (
    <div className="flex justify-around py-4 ">
      <div>
        <Link to="/">
          <h3 className="text-base p-2 border-2 rounded">Back to all post</h3>
        </Link>
      </div>
      <div>
